...
#include  <stdlib.h>
 ...
 SDL_Surface  * screen , *Background , *Pressed1 , *Pressed2 , *Pressed3 , *Pressed4 , *Pressed5 , *scroll ;
 ...
 SDL_Rect dst , dst1 , dst3 ; 
 SDL_Event event ; 
 Mix_Music *scrolling , *pressing , *song ; 
      int  done  =  0 ; 
      int i=1 ; 
     ...
     pressing = Mix_LoadMUS("S.mp3") ;
     scrolling = Mix_LoadMUS("C.mp3") ;
...
break ; 
     ...
     case SDL_MOUSEMOTION : 
      ...
      if (event.motion.x > 168 && event.motion.x < 288 && event.motion.y > 275 && event.motion.y < 295)
      {
     ...
     Mix_PlayMusic(scrolling,1) ; 
	    ...
	    if (event.motion.x > 171 && event.motion.x < 282 && event.motion.y > 321 && event.motion.y < 341)
	    { 
   dst . x  =  0 ; 
     dst . y  =  0 ; 
     dst . w  =  Background -> w ; 
     ...
     Mix_PlayMusic(scrolling,1) ; 
		    ...
		    if (event.motion.x > 179 && event.motion.x < 273 && event.motion.y > 371 && event.motion.y < 389)
{ 	     dst . x  =  0 ; 
     dst . y  =  0 ; 
     dst . w  =  Background -> w ; 
     dst.h  =  Background -> h ; 
     ...
     Mix_PlayMusic(scrolling,1) ; 
			    ...
			    if (event.motion.x > 180 && event.motion.x < 271 && event.motion.y > 417 && event.motion.y < 436 )
	
	{
     ...
     Mix_PlayMusic(scrolling,1) ; 
		...
		if (event.motion.x > 204  && event.motion.x < 252 && event.motion.y > 458 && event.motion.y < 477 )
		{			    
	     dst . x  =  0 ; 
     dst . y  =  0 ; 
     dst . w  =  Background -> w ; 
