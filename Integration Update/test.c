...
void deplacement_aleatoire_animation(ent E,SDL_Surface *screen,SDL_Surface* backg , SDL_Rect positionFond)
{
...
for(i = 0; i<MAX_FRAMES; i++)
		{
			...
			E.frame.w = SPRITE_W;
			E.frame.h = SPRITE_H;
			SDL_BlitSurface(backg, &positionFond, screen, NULL);
